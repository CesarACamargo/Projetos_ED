...
columns_to_normalize_datatime = ['datetime', 'sunrise', 'sunset']
...
def normalize_weather_columns(df: pd.DataFrame) -> pd.DataFrame:
    ...
    logging.info(f"\n ✔️ Coluna 'weather' normalizada - {len(df.columns)} colunas.")
    return df
...
def data_transformations():
    ...
    df = normalize_datatime_columns(df, columns_to_normalize_datatime)
